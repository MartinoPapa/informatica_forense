...
\begin{titlepage}
  ...
  {\normalsize\color{legalegray}
    Documento predisposto per la presentazione in aula\\[0.3em]
    nell'ambito del corso di \textbf{Informatica Forense}\\[1em]
    \textit{Durata prevista: 10 minuti}}
...
ossia di moduli web strutturati per la raccolta di informazioni --- è divenuto
prassi ordinaria in ogni settore: dall'e-commerce alla sanità, dalla pubblica
amministrazione all'istruzione. Tali strumenti consentono di acquisire, con
...
fattore di rischio. Come acutamente osservato dalla dottrina, la straordinaria
importanza dei dati personali nell'epoca attuale risiede nel fatto che
\textquote{essi veicolano la nostra immagine nella rete}; il diritto alla protezione
...
dati particolari (c.d. \emph{sensibili}), oppure in violazione dei principi tecnici
...
di dato raccolto tramite il \emph{form}. L'art.~4, n.~1 del GDPR definisce dato
...
\begin{itemize}[leftmargin=1.5cm]
  ...
  \item \textbf{dati genetici} e \textbf{dati biometrici} (se diretti a identificare
        univocamente una persona);
  \item dati relativi alla \textbf{salute};
  \item dati relativi alla \textbf{vita sessuale} o all'orientamento sessuale.
\end{itemize}
...
dati particolari senza un'esplicita base giuridica ex art.~9 par.~2 è da
...
\begin{normabox}[Art.~9 GDPR -- Trattamento di categorie particolari di dati personali (sintesi)]
  ...
  \newline
  \textit{Fonte: Regolamento (UE) 2016/679, art.~9 \autocite{gdpr2016}.}
\end{normabox}
...
L'art.~5 GDPR enuncia i principi fondamentali del trattamento, applicabili
in via diretta alla predisposizione di qualsiasi \emph{form} online. In particolare:
...
Qualora la base giuridica prescelta sia il \textbf{consenso} (art.~6,
par.~1, lett.~a), l'art.~7 GDPR richiede che esso sia:
\begin{itemize}[leftmargin=1.5cm]
  \item \emph{libero}: l'accesso al servizio non deve essere condizionato alla
        prestazione del consenso per finalità non necessarie;
  \item \emph{specifico}: un unico checkbox che raggruppi più finalità non
        soddisfa il requisito;
  \item \emph{informato}: deve riferirsi a un'informativa adeguata;
  \item \emph{inequivocabile}: le caselle pre-spuntate (\emph{pre-ticked boxes})
...
Sul piano del diritto nazionale, concorrono le disposizioni di cui all'art.~2043
c.c. (responsabilità aquiliana) e, in presenza di trattamento di dati
particolari su larga scala, eventualmente all'art.~2050 c.c. (responsabilità
per attività pericolose), che parimenti prevede un'inversione dell'onere
probatorio \autocite{codicecivile}.
...
Come sottolineato in dottrina, per fronteggiare le violazioni della sfera
della riservatezza nell'ambito digitale, \textquote{nel nostro ordinamento sono
state introdotte alcune norme penali, inserite non nel Codice penale ma nel
d.lgs. 196/2003 (c.d. Codice privacy)}
\autocite[p.~38, \S~2.7]{pietropaoli2022}.
...
delle misure di garanzia di cui all'art.~2-\emph{quinquiesdecies}, qualora
ne derivi nocumento.

La pena è aumentata a \textbf{uno a tre anni} qualora il fatto riguardi
dati genetici, biometrici o relativi alla salute, all'orientamento sessuale,
alle opinioni politiche, all'origine etnica.

\begin{normabox}[Art.~167 D.Lgs. 196/2003 -- Trattamento illecito di dati]
  \small
  ...
  mesi a un anno e sei mesi. 2. Se il fatto di cui al comma 1 riguarda dati
  ...
  \newline
  \textit{Fonte: D.Lgs. 30 giugno 2003, n.~196, art.~167
  \autocite{codiceprivacy2003}.}
\end{normabox}

Ai fini della configurazione del reato, la Corte di Cassazione ha chiarito
che il \emph{nocumento} richiesto dalla norma può sostanziarsi anche in un
danno non patrimoniale e che il \emph{fine di profitto} comprende qualsiasi
vantaggio, anche non economico, che l'agente intenda conseguire mediante
il trattamento illecito \autocite{cass_pen_2019_1285}.

\subsubsection{La comunicazione e diffusione illecita di dati su larga scala (art.~167-bis)}
...
pubblicati senza autorizzazione, configurando un c.d. \textbf{data breach
deliberato}.

Come precisato in dottrina, qualora l'attacco informatico che genera il
data breach comporti \textquote{la divulgazione non autorizzata di dati
personali oggetto di trattamento su larga scala, si potrà fare riferimento
all'art.~167-\emph{bis} del Codice privacy}
\autocite[p.~39, \S~2.7]{pietropaoli2022}.

\subsubsection{L'acquisizione fraudolenta di dati personali (art.~167-ter)}
\label{subsub:art167ter}

L'art.~167-\emph{ter} del Codice Privacy punisce con la reclusione da
\textbf{sei mesi a quattro anni} chiunque, al fine di trarne profitto per sé
...
\subsubsection{Reati informatici connessi (artt.~615-ter e 635-bis c.p.)}
\label{subsub:reatinf}

Nella misura in cui la raccolta illecita di dati tramite \emph{form} si
accompagni all'accesso non autorizzato ai sistemi informatici dell'ente
raccoglitore --- ad esempio per estrarre i dati già archiviati --- potranno
configurarsi ulteriori reati informatici.

Ai sensi dell'art.~615-\emph{ter} c.p. (Accesso abusivo a un sistema informatico
o telematico), introdotto dalla Legge 23 dicembre 1993, n.~547
\autocite{l547_1993}, è punito con la reclusione fino a tre anni chiunque
acceda abusivamente a un sistema informatico protetto. La Cassazione ha chiarito
che \textquote{un account di posta è, difatti, un domicilio informatico protetto
da una password che esprime la volontà dell'utente di farne uno spazio a sé
riservato} \autocite[p.~19, nota 6]{pietropaoli2022}, principio estensibile a
qualsiasi \emph{database} che contenga le informazioni raccolte tramite form
\autocite{cass2021_13057}.

L'art.~635-\emph{bis} c.p. (Danneggiamento di informazioni, dati e programmi
informatici) potrà invece rilevare qualora il trattamento illecito comporti
alterazione o distruzione dei dati degli utenti.
...
\begin{sentenzabox}[Garante per la protezione dei dati personali, Provv. 29 aprile 2021]
  ...
  \newline
  \textit{Fonte: \autocite{garante2021_newsletter}.}
\end{sentenzabox}

\medskip

Il caso illustra paradigmaticamente la fattispecie più frequente: il titolare
...
\begin{sentenzabox}[Garante per la protezione dei dati personali, Provv. 15 settembre 2022]
  ...
  \newline
  \textit{Fonte: \autocite{garante2022_form}.}
\end{sentenzabox}
...
\begin{sentenzabox}[Cass. pen., sez. II, 15 gennaio 2019, n.~1285]
  ...
  \newline
  \textit{Fonte: \autocite{cass_pen_2019_1285}.}
\end{sentenzabox}

\medskip

La sentenza assume rilievo particolare con riferimento ai \emph{form} online che
raccolgono dati a finalità di profilazione commerciale. L'assenza di un'informativa
adeguata e di un consenso valido, unita alla successiva cessione dei dati a terzi,
integra compiutamente la fattispecie penale, indipendentemente dall'entità del
profitto concretamente realizzato.
...
\begin{sentenzabox}[Cass. civ., sez. I, 10 gennaio 2023, n.~407]
  ...
  ulteriore concreto.
  \newline
  \textit{Fonte: \autocite{cass2023_privacyform}.}
\end{sentenzabox}
...
In terzo luogo, come rilevato in dottrina, il quadro normativo applicabile è
tutt'altro che semplice: esso è \textquote{un insieme di norme estremamente
frammentato, che costringe l'interprete a peripezie argomentative continuamente
esposte al rischio di trasformarsi in operazioni ermeneutiche analogiche}
\autocite[p.~37, \S~2.7]{pietropaoli2022}. Ciononostante, la giurisprudenza
del Garante e della Corte di Cassazione ha progressivamente consolidato
principi applicativi chiari, che rendono la materia prevedibile per l'operatore
che intenda conformarsi alla normativa vigente.
