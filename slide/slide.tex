...
\begin{frame}{Riferimenti normativi}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \textbf{\color{legaleblue}Normativa di rango primario}
      \begin{itemize}
    ...
    \end{column}
    \begin{column}{0.48\textwidth}
      \textbf{\color{legaleblue}Diritti fondamentali}
      \begin{itemize}
        \item \textbf{Art. 8} Carta dei Diritti Fondamentali UE (CDFUE)
        \item \textbf{Art. 8} CEDU -- Convenzione Europea dei Diritti dell'Uomo
      \end{itemize}
    \end{column}
  \end{columns}
\end{frame}
